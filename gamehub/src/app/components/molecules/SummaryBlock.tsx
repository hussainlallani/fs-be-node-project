...
export default function SummaryBlock({
  ...
  return (
    <div className="relative h-10 md:h-14 md:mb-2 border-x border-gray-200 dark:border-gray-700 transition-all duration-300 ease-in-out flex flex-col z-50">
      <div
        className={`text-md text-gray-600 dark:text-gray-300 ${
          cardExpanded
            ...
            : "bg-white dark:bg-gray-900 break-all line-clamp-2 px-3 py-2 min-h-14 z-50"
