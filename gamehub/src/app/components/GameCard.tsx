  ...
  return (
    ...
    >
      ...
      <header className="rounded-b-lg">
        ...
        {/* Summary container */}
        <div
          className={`text-sm text-gray-600 dark:text-gray-300 p-3 z-10 break-words w-full transition-all duration-300 ease-in-out
    ${
      cardExpanded
        ? "line-clamp-none pb-2 bg-gray-50 dark:bg-gray-950 rounded-b-lg border-0"
        : "line-clamp-2 pb-0 bg-white dark:bg-gray-900 border-x border-gray-200 dark:border-gray-700 group-hover:line-clamp-none group-hover:pb-3 group-hover:bg-gray-50 group-hover:dark:bg-gray-950 group-hover:rounded-b-lg group-hover:border-b-0"
    }`}
          title={game.summary || "No summary available."}
        >
          Summary: {game.summary || "No summary available."}
        ...
        {/* Button outside clamped block */}
        <div className="block md:hidden px-3 pb-2">
          <ViewMoreButton
            index={index}
            cardExpanded={cardExpanded}
            setCardExpanded={setCardExpanded}
